const countryList = {
  ...
  VUV: "VU", // Vanuatu
  WST: "WS", // Samoa
  XAF: "CM", // CEMAC (Cameroon)
  XCD: "AG", // Organisation of Eastern Caribbean States (Antigua and Barbuda)
  XOF: "SN", // CFA (Senegal)
  XPF: "PF", // Collectivités d'Outre-Mer (French Polynesia)
  YER: "YE", // Yemen
  ZAR: "ZA", // South Africa
  ZMW: "ZM", // Zambia
  ZWL: "ZW", // Zimbabwe
